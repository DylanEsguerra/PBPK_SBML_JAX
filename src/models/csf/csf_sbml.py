...
# creates C_BCSFB_unbound_brain and C_BCSFB_bound_brain which are used in brain_sbml.py
import libsbml
...
def create_csf_model(params):
    ...
    bcsfb_unbound.setUnits("millilitre")
    ...
    bcsfb_bound.setUnits("millilitre")
    ...
    lateral_ventricle.setUnits("millilitre")
    ...
    third_fourth_ventricle.setUnits("millilitre")
    ...
    cisterna_magna.setUnits("millilitre")
    ...
    subarachnoid_space.setUnits("millilitre")
...
def main(params):
    ...
    output_path = output_dir / "csf_sbml.xml"
    ...
    if document.getNumErrors() != 0:
        ...
        print(f"CSF model saved successfully to {output_path}!") 