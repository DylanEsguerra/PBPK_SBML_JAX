...
# uses C_p_lung and C_BC_lung which come from blood_sbml.py
import libsbml
...
def main(params):
    ...
    if document.getNumErrors() != 0:
        ...
        save_model(document, "brain_sbml.xml")
